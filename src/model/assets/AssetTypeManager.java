...
public class AssetTypeManager extends EnterMediaObject
{
	...
	{
		// MediaArchive mediaarchive = (MediaArchive) context.getPageValue("mediaarchive");//Search for all
		// files looking for videos
	...
	{
		/*
		 * String path = inAssetHit.getSourcePath().toLowercase(); if( path.contains("/links/") ) { return
		 * "links"; } if( path.contains("/press ready pdf/") || path.endsWith("_pfinal.pdf") ) { return
		 * "printreadyfinal"; }
		 */
		return inSuggested;
	}
