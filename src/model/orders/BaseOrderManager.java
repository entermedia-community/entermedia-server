...
public class BaseOrderManager implements OrderManager, CatalogEnabled
{
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.entermediadb.asset.orders.OrderManager#createOrder(java.lang.String,
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.entermediadb.asset.orders.OrderManager#saveItems(java.lang.String,
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.entermediadb.asset.orders.OrderManager#saveOrder(java.lang.String,
	...
	public List<String> addConversionAndPublishRequest(WebPageRequest inReq, Order order, MediaArchive archive, Map<String, String> properties, User inUser)
	{
		...
		// Searcher taskSearcher = getSearcherManager().getSearcher(archive.getCatalogId(),
		// "conversiontask");
		...
		for (Iterator iterator = hits.iterator(); iterator.hasNext();)
		{
			...
			// Data dest = getSearcherManager().getData(archive.getCatalogId(), "publishdestination",
			// destination);
	 ...
	 * 
	 * @see
	 * org.entermediadb.asset.orders.OrderManager#getPublishDestinationForOrderItem(java.lang.String,
	 * org.openedit.Data)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.entermediadb.asset.orders.OrderManager#updateStatus(org.entermediadb.asset.MediaArchive,
	 * org.entermediadb.asset.orders.Order)
	 */
	...
	protected void sendOrderNotifications(MediaArchive inArchive, Order inOrder)
	{
		...
		// sendEmail(inArchive.getCatalogId(),context, owneremail, "/" + appid +
		// "/theme/emails/usertemplate.html");
		// }
		// }
		// }
		// }
