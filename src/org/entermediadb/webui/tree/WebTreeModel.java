...
public interface WebTreeModel
{
	 ...
	 * <code>parent</code> must be a node previously obtained from this data source. This should not
	 * return <code>null</code> if <code>index</code> is a valid index for <code>parent</code> (that is
	 * <code>index &gt;= 0 && index &lt;
	 ...
	 * return <code>false</code> even if <code>node</code> has no children. A directory in a filesystem,
	 * for example, may contain no files; the node representing the directory is not a leaf, but it also
	 * has no children.
	 *
	...
	/**
	 * Returns a unique ID for the given node. This ID should be unique throughout the tree.
	 * 
