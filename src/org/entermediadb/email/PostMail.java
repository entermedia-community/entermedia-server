...
public class PostMail {
	...
	public void postMail(String[] recipients, String subject, String inHtml, String inText, String from)
	...
	public void postMail(List<InternetAddress> recipients, String subject, String inHtml, String inText,
			InternetAddress inFrom, List inAttachments, Map inProperties) throws MessagingException {
	...
	public void postMail(List<InternetAddress> recipients, List<InternetAddress> blindrecipients, String subject,
			String inHtml, String inText, InternetAddress from, List inAttachments, Map inProperties)
			throws MessagingException {
		...
		log.info("Sending email from: " + Arrays.asList(msg.getFrom()) + " To: " + Arrays.asList(addressTo)
				+ " Subject: " + subject);
		Transport.send(msg);
	}
