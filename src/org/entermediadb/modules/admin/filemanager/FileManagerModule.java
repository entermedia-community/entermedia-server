...
public class FileManagerModule extends BaseModule {
	 ...
	 * Example:
	 * <input type="hidden" name="param-part" value=
	 * "${page.filerootpath}/index.html?path=" />
	...
	public void movePage(WebPageRequest inReq) throws OpenEditException {
		...
		if (inReq.getUser().hasPermission("oe.administration")
				|| Boolean.parseBoolean(inReq.getPageProperty("allowmove"))
				|| inReq.getUser().isInGroup("administrators")) {
		} else {
