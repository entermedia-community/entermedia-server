...
public class Replacer
{
	...
	protected void replaceTextInFile(File inFile) throws Exception
	{
		...
		try
		{
			...
			String path = URLUtilities.getPathWithoutContext(getRootDirectory().getAbsolutePath(), inFile.getAbsolutePath(), "index.html"); // This is an off API to use for this. TODO: Replace with
																																			// PathUtilities
	...
	protected void replaceAllInDirectory(File inDirectory) throws Exception
	{
		if (inDirectory.isDirectory())
		{
			...
			if (fileMatchesFileTypes(inDirectory))
			{
