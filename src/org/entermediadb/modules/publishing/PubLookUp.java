...
public class PubLookUp implements CatalogEnabled
{
	...
	public String lookUpSourcepathbyPubId(String pubitem, String pubsku)
	{
		...
		/*
		 * ignore none 00- ? ignore zz numeric id (00-###) -> ####-####/###-##/### alphanumeric (00-ABC) ->
		 * Warner-A/ABC
		 * 
