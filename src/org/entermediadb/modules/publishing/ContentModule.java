...
import org.entermediadb.postiz.PostizManager;
...
public class ContentModule extends BaseMediaModule
{
	...
	// {
	//
	// Collection<PropertyDetail> details =
	// targetsearcher.getDetailsForView("contentcreatoraddnewimages");
	//
	// for (Iterator iterator = details.iterator(); iterator.hasNext();)
	// {
	// PropertyDetail detail = (PropertyDetail) iterator.next();
	// if (detail.isList() && ("asset".equals(detail.getListId()) ||
	// "asset".equals(detail.get("rendertype"))))
	// {
