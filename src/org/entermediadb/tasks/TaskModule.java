...
//	}
	...
	protected void loadTasksForGoal(WebPageRequest inReq, MultiValued goal)
	{
		...
		QueryBuilder query = tasksearcher.query().match("projectgoal", goal.getId());
...
//		Collections.sort(types);
	...
	public void loadUserTickets(WebPageRequest inReq) throws Exception
	{
		...
		opengoalbuilder.orgroup("projectstatus", "active|open|critical").sort("projectstatus").sort("creationdateDown");
