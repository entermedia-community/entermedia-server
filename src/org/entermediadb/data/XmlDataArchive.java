...
public class XmlDataArchive implements DataArchive
{
	...
	/*
	 * protected void populateElement(Element inElement, Data inData) { for (Iterator iterator =
	 * inData.getProperties().keySet().iterator(); iterator.hasNext();) { String detail = (String)
	 * iterator.next(); if( !detail.equals("id") && !detail.equals("sourcepath") &&
	 * !detail.startsWith(".")) { String value = inData.get(detail); if( value != null) {
