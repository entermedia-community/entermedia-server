...
public class OllamaConnection extends OpenAiConnection implements CatalogEnabled, LlmConnection {
	...
	/*
	 * 
	 * public BasicLlmResponse runPageAsInput(AgentContext llmrequest, String
	 * inTemplate)
	 * {
	 ...
	 * 
	 * JSONObject json = getConnection().parseMap(resp); // pretty dumb but I want
	 * to standardize on GSON
	 * 
	 ...
	 * "/ai/ollama/classify/functions/" + inFunction + ".json";
	 * 
	 * Page defpage = archive.getPageManager().getPage(templatepath);
	 * 
	 * if(!defpage.exists()) {
	 * templatepath ="/" + archive.getCatalogId() + "/ai/ollama/classify/functions/"
	 * + inFunction + ".json";
	 ...
	 * if(!defpage.exists()) {
	 * throw new
	 * OpenEditException("Requested Content Does Not Exist in MediaDB or Catalog:" +
	 * inFunction);
	 * }
	 * 
	 * if(textContent == null)
	 ...
	 * getMediaArchive().getMediaDbId() + "/ai/ollama/classify/structures/" +
	 * inFuction + ".json", inParams);
	 * 
