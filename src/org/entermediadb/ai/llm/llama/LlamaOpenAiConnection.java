...
public class LlamaOpenAiConnection extends OpenAiConnection
{
	...
	// String structurepath = "/" + getMediaArchive().getMediaDbId() + "/ai/" +
	// getLlmProtocol() +"/classify/structures/" + getAiFunctionName() +
	// "_structure.json";
	...
	//
	//
	// String propmpt = loadInputFromTemplate("/" + getMediaArchive().getMediaDbId()
	// + "/ai/" + getLlmProtocol() +"/classify/structures/" + getAiFunctionName() +
	// ".json", inParams);
	//
