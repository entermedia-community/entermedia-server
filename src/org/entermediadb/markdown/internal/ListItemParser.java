...
import org.entermediadb.markdown.node.ListItem;
...
public class ListItemParser extends AbstractBlockParser
{
    ...
    /**
     * Minimum number of columns that the content has to be indented (relative to the containing block)
     * to be part of this list item.
     */
