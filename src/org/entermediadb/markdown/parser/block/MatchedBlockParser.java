...
public interface MatchedBlockParser
{
    ...
    /**
     * Returns the current paragraph lines if the matched block is a paragraph. If you want to use some
     * or all of the lines for starting a new block instead, use
