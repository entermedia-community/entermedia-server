...
public interface ParserState
{
     ...
     * tab stops. If the line doesn't contain any tabs, it's the same as the {@link #getIndex()}. If the
     * line starts with a tab, followed by text, then the column for the first character of the text is
     * 4 (the index is 1).
     *
    ...
    /**
     * @return the indentation in columns (either by spaces or tab stop of 4), starting from
     *         {@link #getColumn()}
     */
    int getIndent();
