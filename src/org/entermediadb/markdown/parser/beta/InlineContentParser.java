 ...
 * {@link InlineContentParserFactory} and created by its
 * {@link InlineContentParserFactory#create() create} method. The lifetime of
 * this is tied to each inline content
...
public interface InlineContentParser {
     ...
     * is one of {@link InlineContentParserFactory#getTriggerCharacters()} of the
     * factory that created this parser.
     * <p>
     * For a given inline content snippet that is being parsed, this method can be
     * called multiple times: each time a
     * trigger character is encountered.
     *
     * @param inlineParserState the current state of the inline parser
     * @return the result of parsing; can indicate that this parser is not
     *         interested, or that parsing was successful
     */
