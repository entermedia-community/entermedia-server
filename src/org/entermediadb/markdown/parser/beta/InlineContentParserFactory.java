 ...
 * <p>
 * See {@link org.entermediadb.markdown.parser.Parser.Builder#customInlineContentParserFactory} for
 * how to register it.
 */
public interface InlineContentParserFactory
{
     ...
     * snippet of inline content inside block structures, and then called each time a trigger character
     * is encountered.
     */
