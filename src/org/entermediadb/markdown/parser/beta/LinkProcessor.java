 ...
 * {@link org.entermediadb.markdown.parser.Parser.Builder#linkProcessor}. Then, when inline parsing
 * is run, each parsed link/image is passed to the processor. This includes links like these:
 * <p>
 * 
 * <pre>
 * <code>
 ...
 * <p>
 * The processor can then inspect the link/image and decide what to do with it by returning the
