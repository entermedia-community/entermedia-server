...
public interface DelimiterRun {
    ...
    /**
     * @return the number of characters in this delimiter run (that are left for
     *         processing)
     */
    int length();

    /**
     * @return the number of characters originally in this delimiter run; at the
     *         start of processing, this is the same
     *         as {{@link #length()}}
     */
    int originalLength();

    /**
     * @return the innermost opening delimiter, e.g. for {@code ***} this is the
     *         last {@code *}
     */
    Text getOpener();

    /**
     * @return the innermost closing delimiter, e.g. for {@code ***} this is the
     *         first {@code *}
     */
    Text getCloser();
     ...
     * {@link #length()}.
     * <p>
     * For example, for a delimiter run {@code ***}, calling this with 1 would
     * return the last {@code *}.
     * Calling it with 2 would return the second last {@code *} and the last
     * {@code *}.
     */
