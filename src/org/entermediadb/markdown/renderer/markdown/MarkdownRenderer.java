...
import org.entermediadb.markdown.internal.renderer.NodeRendererMap;
import org.entermediadb.markdown.node.Node;
import org.entermediadb.markdown.renderer.NodeRenderer;
import org.entermediadb.markdown.renderer.Renderer;
 ...
 * <ul>
 * <li>Headings are output as ATX headings if possible (multi-line headings need Setext
 * headings)</li>
 * <li>Links are always rendered as inline links (no support for reference links yet)</li>
 * <li>Escaping might be over-eager, e.g. a plain {@code *} might be escaped even though it doesn't
 * need to be in that particular context</li>
