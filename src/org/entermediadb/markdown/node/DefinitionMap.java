...
public class DefinitionMap<D>
{
    ...
    /**
     * Store a new definition unless one is already in the map. If there is no definition for that label
     * yet, return null. Otherwise, return the existing definition.
     * <p>
