...
public class FencedCodeBlock extends Block
{
    ...
    /**
     * @return the length of the opening fence (how many of {{@link #getFenceCharacter()}} were used to
     *         start the code block) if available, or null otherwise
     */
    ...
    /**
     * @return the length of the closing fence (how many of {@link #getFenceCharacter()} were used to
     *         end the code block) if available, or null otherwise
     */
