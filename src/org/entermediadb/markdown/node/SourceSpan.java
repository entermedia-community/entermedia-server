 ...
 * <p>
 * Note that the column index and length are measured in Java characters (UTF-16 code units). If
...
public class SourceSpan
{
    ...
    /**
     * @deprecated Use {{@link #of(int, int, int, int)}} instead to also specify input index. Using the
     *             deprecated one will set {@link #inputIndex} to 0.
     */
    @Deprecated
    ...
    /**
     * @return 0-based index of column (character on line) in source, e.g. 0 for the first character of
     *         a line, 1 for the second character, etc
     */
