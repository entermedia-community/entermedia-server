 ...
 * etc).
 * <p>
 * Note that a list item can't directly contain {@link Text}, it needs to be: {@link ListItem} :
...
public class ListItem extends Block
{
     ...
     * otherwise. The content indent is counted from the beginning of the line and includes the marker
     * on the first line.
     * <p>
     ...
     * Content indent: 5
     * <p>
     * Note that subsequent lines in the same list item need to be indented by at least the content
     * indent to be counted as part of the list item.
     */
    ...
    /**
     * @deprecated list items should only contain block nodes; if you're trying to create a list that is
     *             rendered without paragraphs, use {@link ListBlock#setTight(boolean)} instead.
     */
    @Override
    @Deprecated
