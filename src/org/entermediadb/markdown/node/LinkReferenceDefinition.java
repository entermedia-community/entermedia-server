 ...
 * </pre>
 * <p>
 * They can be referenced anywhere else in the document to produce a link using <code>[foo]</code>.
 * The definitions themselves are usually not rendered in the final output.
 *
