...
/**
 * A list of source spans that can be added to. Takes care of merging adjacent
 * source spans.
 *
 * @since 0.16.0
 */
    ...
    public void addAll(List<SourceSpan> other) {
        ...
        if (sourceSpans.isEmpty()) {
            ...
            if (a.getInputIndex() + a.getLength() == b.getInputIndex()) {
                sourceSpans.set(lastIndex, SourceSpan.of(a.getLineIndex(), a.getColumnIndex(), a.getInputIndex(),
