...
/**
 * A link with a destination and an optional title; the link text is in child
 * nodes.
 * <p>
 ...
 * <li>A {@link Text} child node with {@link Text#getLiteral() getLiteral} that
 * returns {@code "link"}</li>
 * </ul>
 * <p>
 * Note that the text in the link can contain inline formatting, so it could
 * also contain an {@link Image} or
 * {@link Emphasis}, etc.
 *
