...
public class IdManager
{
	...
	public UniqueId grabLock(UniqueId lock, String inPath, Searcher inSearcher)
	{
		...
		if (lock.isLocked())
		{
			// log.info("Local was alreadY locked - returning null. CatalogID:" +
			// inSearcher.getCatalogId() + " Thread: " + Thread.currentThread().getId() +
			// "Lock ID" + lock.getId() + " Searcher: " + inSearcher.getClass());
			return null;
		}
