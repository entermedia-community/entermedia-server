...
public class ZipGroup {
	...
	protected String buildMissingDocumentsText(List<Asset> inMissingDocumentItems) {
		StringBuffer missingAssetsStr = new StringBuffer(
				"Original documents for the following could not be retrieved:\n\n");
				...
				if (documentFile == null || !documentFile.exists()) {
					...
					try {
						...
						if (instructions != null) {
							ConversionManager manager = getMediaArchive().getTranscodeTools()
									.getManagerByFileFormat(instructions.getOutputExtension());
