...
public class AssetSecurityPageArchive implements AssetSecurityArchive
{
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.entermediadb.asset.search.AssetSecurity#getAccessList(org.entermediadb.
	...
	private void collectUsers(List add, Filter inRoot, Asset inAsset)
	{
		if (inRoot instanceof UserFilter)
		{
			...
			if (inRoot instanceof GroupFilter)
			{
				...
				if (inRoot instanceof BlankFilter)
				{
					add.add("true");
				}
				else
					if (inRoot instanceof BooleanFilter)
					{
						...
						if (inRoot instanceof SettingsGroupFilter)
						{
							...
							if (inRoot instanceof UserProfileFilter)
							{
								...
								if (inRoot instanceof NotFilter)
								{
									// Cant process not filters within an index
									return;
								}
								else
									if (inRoot instanceof ActionFilter)
									{
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.entermediadb.asset.search.AssetSecurity#revokeViewAccess(org.entermediadb
	 ...
	 * entermediadb.asset.MediaArchive, java.lang.String, org.entermediadb.asset.Asset)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.entermediadb.asset.search.AssetSecurity#grantViewAccess(org.entermediadb.
	 * asset.MediaArchive, java.lang.String, org.entermediadb.asset.Asset)
	 */
	 ...
	 * 
	 * @see org.entermediadb.asset.search.AssetSecurity#grantGroupViewAccess(org.
	 * entermediadb.asset.MediaArchive, java.util.Collection, org.entermediadb.asset.Asset)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.entermediadb.asset.search.AssetSecurity#grantAllAccess(org.entermediadb.
	 * asset.MediaArchive, org.entermediadb.asset.Asset)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.entermediadb.asset.search.AssetSecurity#revokeAllAccess(org.entermediadb.
	 * asset.MediaArchive, org.entermediadb.asset.Asset)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.entermediadb.asset.search.AssetSecurity#grantAccess(org.entermediadb.
	 * asset.MediaArchive, java.lang.String, org.entermediadb.asset.Asset, java.lang.String)
	 */
	 ...
	 * 
	 * @see org.entermediadb.asset.search.AssetSecurity#grantAccess(org.entermediadb.
	 * asset.MediaArchive, java.lang.String, org.openedit.page.Page, java.lang.String)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.entermediadb.asset.search.AssetSecurity#checkAssetPermissions(org. openedit.users.User,
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.entermediadb.asset.search.AssetSecurity#clearViewAccess(org.entermediadb.
	 * asset.MediaArchive, org.entermediadb.asset.Asset)
	 */
