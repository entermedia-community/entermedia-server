...
public class AssetSecurityPageArchive implements AssetSecurityArchive {
	 ...
	 * 
	 * @see
	 * org.entermediadb.asset.search.AssetSecurity#getAccessList(org.entermediadb.
	 * asset.MediaArchive, org.entermediadb.asset.Asset)
	 */
	...
	public List getAccessList(MediaArchive inArchive, Asset inAsset) throws OpenEditException {
		...
		// )}.html
		// Page page = getPageManager().getPage(inArchive.getCatalogHome() + "/assets/"
		// + path + ".html");
	 ...
	 * 
	 * @see
	 * org.entermediadb.asset.search.AssetSecurity#revokeViewAccess(org.entermediadb
	 * .asset.MediaArchive, java.lang.String, org.entermediadb.asset.Asset)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.entermediadb.asset.search.AssetSecurity#revokeGroupViewAccess(org.
	 * entermediadb.asset.MediaArchive, java.lang.String,
	 * org.entermediadb.asset.Asset)
	 */
	 ...
	 * 
	 * @see
	 * org.entermediadb.asset.search.AssetSecurity#grantViewAccess(org.entermediadb.
	 * asset.MediaArchive, java.lang.String, org.entermediadb.asset.Asset)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.entermediadb.asset.search.AssetSecurity#grantGroupViewAccess(org.
	 * entermediadb.asset.MediaArchive, java.lang.String,
	 * org.entermediadb.asset.Asset)
	 */
	 ...
	 * 
	 * @see org.entermediadb.asset.search.AssetSecurity#grantGroupViewAccess(org.
	 * entermediadb.asset.MediaArchive, java.util.Collection,
	 * org.entermediadb.asset.Asset)
	 */

	public void grantGroupViewAccess(MediaArchive inArchive, Collection<String> groupnames, Asset inAsset)
	 ...
	 * 
	 * @see
	 * org.entermediadb.asset.search.AssetSecurity#grantAllAccess(org.entermediadb.
	 * asset.MediaArchive, org.entermediadb.asset.Asset)
	 */
	 ...
	 * 
	 * @see
	 * org.entermediadb.asset.search.AssetSecurity#revokeAllAccess(org.entermediadb.
	 * asset.MediaArchive, org.entermediadb.asset.Asset)
	 */
	 ...
	 * 
	 * @see
	 * org.entermediadb.asset.search.AssetSecurity#grantAccess(org.entermediadb.
	 * asset.MediaArchive, java.lang.String, org.entermediadb.asset.Asset,
	 * java.lang.String)
	 */

	public void grantAccess(MediaArchive inArchive, String username, Asset inAsset, String inView)
			throws OpenEditException {
		String path = inArchive.getCatalogHome() + "/assets/" + inAsset.getSourcePath() + "/_site.xconf";
	 ...
	 * @see
	 * org.entermediadb.asset.search.AssetSecurity#grantViewAccess(org.entermediadb.
	 * asset.MediaArchive, org.openedit.users.User, org.entermediadb.asset.Category)
	 */
	 ...
	 * @see
	 * org.entermediadb.asset.search.AssetSecurity#grantAccess(org.entermediadb.
	 * asset.MediaArchive, java.lang.String, org.openedit.page.Page,
	 * java.lang.String)
	 */
	...
	public void grantGroupAccess(MediaArchive inArchive, Collection<String> inGroups, Page inPage,
			String inPermission) {
		PageSettings settings = inPage.getPageSettings();
		Permission permission = settings.getPermission(inPermission);
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.entermediadb.asset.search.AssetSecurity#checkAssetPermissions(org.
	 * openedit.users.User, java.lang.String, java.lang.String)
	 */
	...
	public Map checkAssetPermissions(User inUser, String inCatalogId, String sourcePath) {
		...
		List names = Arrays
				.asList(new String[] { "customdownload", "download", "forcewatermark", "viewasset", "view" });
	 ...
	 * 
	 * @see
	 * org.entermediadb.asset.search.AssetSecurity#clearViewAccess(org.entermediadb.
	 * asset.MediaArchive, org.entermediadb.asset.Asset)
	 */
	...
	public void clearViewAccess(MediaArchive inArchive, Asset inJobfolder) {
		// $home$cataloghome/assets/${store.assetPathFinder.idToPath($cell.id
		// )}.html
		Page page = getPageManager()
				.getPage(inArchive.getCatalogHome() + "/assets/" + inJobfolder.getSourcePath() + "/_site.xconf");
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.entermediadb.asset.search.AssetSecurity#hasAnonymousViewAsset(org.
	 * entermediadb.asset.Asset)
	 */
