...
public class ffmpegVideoConverter extends BaseTranscoder implements ConversionManager
{
	private static final Log log = LogFactory.getLog(ffmpegVideoConverter.class);
