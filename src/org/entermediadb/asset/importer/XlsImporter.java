...
public class XlsImporter extends BaseImporter
{
	...
	public void importData() throws Exception
	{
		 ...
		 * 
		 * // For each row, iterate through all the columns Iterator<Cell> cellIterator =
		 * row.cellIterator();
		 * 
		 ...
		 * Cell.CELL_TYPE_NUMERIC: default: System.out.print(cell.getNumericCellValue() + "t"); break;
		 * //case Cell.CELL_TYPE_STRING: // System.out.print(cell.getStringCellValue() + "t"); // break; } }
