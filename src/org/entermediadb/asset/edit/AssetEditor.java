...
public class AssetEditor
{
	...
	public boolean makeFolderAsset(Asset inAsset, User inUser)
	{
		...
		// deleted!
		/*
		 * We dont use .xconf to store data files any more if (!oldSourcePath.equals(newSourcePath)) { //
		 * Remove old asset file File oldFile = new File(getMediaArchive().getRootDirectory(), "assets/" +
		 * oldSourcePath + ".xconf"); if (oldFile.exists()) { if (oldFile.delete()) { return true; } else {
