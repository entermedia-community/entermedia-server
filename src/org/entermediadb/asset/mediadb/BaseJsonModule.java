...
{
	private static String VALID_HEADERS = "x-csrf-token,x-file-name,x-file-size,x-requested-with,x-email,x-token,x-tokentype,cache-control,access-control-allow-credentials,access-control-allow-origin,access-control-allow-headers,access-control-allow-method,content-type, ";
