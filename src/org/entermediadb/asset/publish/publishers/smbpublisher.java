...
public class smbpublisher extends BasePublisher implements Publisher {
	...
	public PublishResult publish(MediaArchive mediaArchive, Order inOrder, Data inOrderItem, Data inDestination,
		...
		//
		// log.info("Publishing ${asset} to smb server ${servername}, with username
		// ${username}.");
		//
		// //get password and login
		// UserManager userManager = (UserManager)
		// mediaArchive.getModuleManager().getBean("userManager");
		...
		// url = url + "/";
		// }
		// String sambaurl = "smb://" + username + ":" + password + "@" + servername +
		// url;
