...
public class JsonUtil {
	public String formatDateObj(Object inDate) {
		...
		// String json = DateStorageUtil.getStorageUtil().formatDateObj((Date)inDate,
	...
	protected SearchQuery parseQuery(WebPageRequest inReq, Map query, Searcher inSearcher) {
		...
		for (Iterator iterator = terms.iterator(); iterator.hasNext();) {
			...
			// String highval = inPageRequest.getRequestParameter(field.getId() +
			// ".highval");
			// String lowval = inPageRequest.getRequestParameter(field.getId() + ".lowval");

			// String[] beforeStrings = inPageRequest.getRequestParameters(field.getId() +
			// ".before");
			// String[] afterStrings = inPageRequest.getRequestParameters(field.getId() +
			// ".after");
