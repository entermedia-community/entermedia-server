...
/**
 * @version $Id: NumberUtils.java,v 1.1 2010/03/29 19:01:45 cburkey Exp $
 */
public class NumberUtils {
  ...
  //
  public  String float2sortableStr(float val) {
    int f = Float.floatToRawIntBits(val);
    if (f<0) f ^= 0x7fffffff;
    return int2sortableStr(f);
  }

  public  String float2sortableStr(String val) {
    return float2sortableStr(Float.parseFloat(val));
  }

  public  float SortableStr2float(String val) {
    int f = SortableStr2int(val,0,3);
    if (f<0) f ^= 0x7fffffff;
    return Float.intBitsToFloat(f);
  }

  public  String SortableStr2floatStr(String val) {
    return Float.toString(SortableStr2float(val));
  }


  public  String double2sortableStr(double val) {
    long f = Double.doubleToRawLongBits(val);
    if (f<0) f ^= 0x7fffffffffffffffL;
    return long2sortableStr(f);
  }

  public  String double2sortableStr(String val) {
    return double2sortableStr(Double.parseDouble(val));
  }

  public  double SortableStr2double(String val) {
    long f = SortableStr2long(val,0,6);
    if (f<0) f ^= 0x7fffffffffffffffL;
    return Double.longBitsToDouble(f);
  }

  public  String SortableStr2doubleStr(String val) {
  ...
  public  int int2sortableStr(int val, char[] out, int offset) {
  ...
  public  int SortableStr2int(String sval, int offset, int len) {
  ...
  public  int long2sortableStr(long val, char[] out, int offset) {
    val += Long.MIN_VALUE;
  ...
  public  long SortableStr2long(String sval, int offset, int len) {
