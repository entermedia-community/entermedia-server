$(document).ready(function () {
  ...
  $(".product .thumb .productlink").on("click", function () {
    var parentnode = $(this).parent();
    var productid = parentnode.data("productid");

    var cpid = parentnode.data("cpid");
    $("#product-dialog").load(
      clientroot +
        "/details/productdetails.html?productid=" +
        productid +
        "&cp=" +
        cpid +
        "&oemaxlevel=1",
  ...
  jQuery("body").on(
    ...
    function () {
      ...
      var departmentasset = jQuery(this).data("dataid");
...
loadCueMenu = function (cueid) {
  ...
  var clientroot = jQuery("#showcaseclient").data("clientroot");
  jQuery("#cuepointactions").load(
    clientroot +
      "/details/cuepointactions.html?cueid=" +
      cueid +
      "&dataid=" +
      dataid
  );
...
reloadCues = function (paused, startingcue) {
  ...
  jQuery("#video-cuepoints").load(
    clientroot +
      "/details/cuepoints.html?oemaxlevel=1&id=" +
      videoid +
      "&paused=" +
      pstatus,
    function () {
...
reloadProducts = function () {
  ...
  var clientroot =
    app.data("home") + jQuery("#showcaseclient").data("clientroot");
  jQuery("#cuepoint-products").load(
    clientroot + "/details/cuepointproducts.html?cueid=" + videoid
  );
};
