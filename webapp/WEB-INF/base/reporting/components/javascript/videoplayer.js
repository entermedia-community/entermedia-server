										...
										jQuery
												.ajax({
													url : clientroot
															...
															+ time
															+ "&field=departmentasset&departmentasset.value="
															+ departmentasset + "&id=" + departmentasset,
...
//					
					...
					jQuery(".shiftLeft").on('click', function() {
					...
					jQuery(".shiftRight").on('click', function() {
						var amount = jQuery(this).data("amount");
						if (amount == null) {
							amount = 1;
						}
...
loadCueMenu= function(cueid){
	...
	var clientroot = jQuery("#showcaseclient").data("clientroot");
	jQuery("#cuepointactions").load(clientroot + "/details/cuepointactions.html?oemaxlevel=1&cueid=" + cueid);
}
