...
public void handlePost(){
	...
	if(id != null){
		...
		asset.setId(searcher.nextAssetNumber());
	}
	request.each{
		println it;
		String key = it.key;
	...
	String sourcepath = archive.getCatalogSettingValue("catalogassetupload");  //${division.uploadpath}/${user.userName}/${formateddate}
	sourcepath = sm.getValue(catalogid, sourcepath, asset.getProperties());
